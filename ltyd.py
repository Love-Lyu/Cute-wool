...
#random_sleep(0, 1600) #自定义延迟运行

#主类
class China_Unicom:
    def __init__(self, LTphone):
        self.LTphone = LTphone
        self.headers = {
    ...
    def get_userinfo(self):
        ...
        crypt_text = f'{{"phone":"{self.LTphone}","timestamp":"{date}"}}'
